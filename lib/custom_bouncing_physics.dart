...
///    clamping behavior.
class CustomBouncingPhysics extends ScrollPhysics {
  /// Creates scroll physics that bounce back from the edge.
  const CustomBouncingPhysics({ScrollPhysics parent}) : super(parent: parent);
  ...
  double frictionFactor(double overscrollFraction) =>
      25.0 * math.pow(1 - overscrollFraction, 2);
...
///  * [CustomBouncingPhysics], which is the analogous physics for iOS' bouncing
///    behavior.
